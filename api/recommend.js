...
const UNIVERSITIES = [
  ...
  { nameAr: 'جامعة بافالو', nameEn: 'University at Buffalo (SUNY)', country: 'الولايات المتحدة', city: 'Buffalo, NY', tier: 2, minGpa: 3.1, fields: ['engineering', 'business', 'medical', 'cs'], email: 'ub-admissions@buffalo.edu', weather: 'cold', safety: 'safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'large', prayerRoom: 'yes' } },
  { nameAr: 'جامعة ولاية آيوا', nameEn: 'Iowa State University', country: 'الولايات المتحدة', city: 'Ames, IA', tier: 2, minGpa: 3.0, fields: ['engineering', 'science', 'business', 'cs'], email: 'admissions@iastate.edu', weather: 'cold', safety: 'safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  { nameAr: 'جامعة ألاباما', nameEn: 'University of Alabama', country: 'الولايات المتحدة', city: 'Tuscaloosa, AL', tier: 3, minGpa: 2.8, fields: ['engineering', 'business', 'medical', 'social'], email: 'admissions@ua.edu', weather: 'hot', safety: 'safe', muslimFriendly: { halal: 'limited', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  ...
  { nameAr: 'جامعة نيفادا لاس فيغاس', nameEn: 'University of Nevada, Las Vegas', country: 'الولايات المتحدة', city: 'Las Vegas, NV', tier: 3, minGpa: 2.7, fields: ['business', 'engineering', 'cs', 'social'], email: 'admissions@unlv.edu', weather: 'hot', safety: 'safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  // UK additions
  ...
  // ── New countries ──
  // Germany
  { nameAr: 'الجامعة التقنية ميونيخ', nameEn: 'Technical University of Munich (TUM)', country: 'ألمانيا', city: 'Munich', tier: 1, minGpa: 3.5, fields: ['engineering', 'cs', 'science', 'business'], email: 'international@tum.de', englishGradOnly: true, weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  { nameAr: 'جامعة لودفيغ ماكسيميليان ميونيخ', nameEn: 'Ludwig Maximilian University of Munich (LMU)', country: 'ألمانيا', city: 'Munich', tier: 1, minGpa: 3.5, fields: ['medical', 'science', 'law', 'social'], email: 'international@lmu.de', englishGradOnly: true, weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  { nameAr: 'جامعة هايدلبرغ', nameEn: 'Heidelberg University', country: 'ألمانيا', city: 'Heidelberg', tier: 1, minGpa: 3.5, fields: ['medical', 'science', 'social', 'law'], email: 'international@uni-heidelberg.de', englishGradOnly: true, weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'small', prayerRoom: 'unknown' } },
  ...
  { nameAr: 'جامعة فرايبورغ', nameEn: 'University of Freiburg', country: 'ألمانيا', city: 'Freiburg', tier: 2, minGpa: 3.2, fields: ['medical', 'science', 'law', 'education'], email: 'international@uni-freiburg.de', englishGradOnly: true, weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'small', prayerRoom: 'unknown' } },
  { nameAr: 'جامعة غوتنغن', nameEn: 'University of Göttingen', country: 'ألمانيا', city: 'Göttingen', tier: 2, minGpa: 3.2, fields: ['science', 'medical', 'social', 'law'], email: 'international@uni-goettingen.de', englishGradOnly: true, weather: 'cold', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'limited', saudiCommunity: 'small', prayerRoom: 'unknown' } },
  ...
  { nameAr: 'الجامعة التقنية درسدن', nameEn: 'TU Dresden', country: 'ألمانيا', city: 'Dresden', tier: 2, minGpa: 3.0, fields: ['engineering', 'cs', 'science', 'education'], email: 'international@tu-dresden.de', englishGradOnly: true, weather: 'cold', safety: 'safe', muslimFriendly: { halal: 'moderate', mosque: 'limited', saudiCommunity: 'small', prayerRoom: 'yes' } },
  // Ireland
  { nameAr: 'كلية ترينيتي دبلن', nameEn: 'Trinity College Dublin (TCD)', country: 'أيرلندا', city: 'Dublin', tier: 1, minGpa: 3.5, fields: ['law', 'business', 'science', 'arts', 'social'], email: 'international@tcd.ie', weather: 'cold', safety: 'very_safe', muslimFriendly: { halal: 'easy', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  { nameAr: 'جامعة كولدج دبلن', nameEn: 'University College Dublin (UCD)', country: 'أيرلندا', city: 'Dublin', tier: 1, minGpa: 3.4, fields: ['business', 'engineering', 'medical', 'law', 'social'], email: 'international@ucd.ie', weather: 'cold', safety: 'very_safe', muslimFriendly: { halal: 'easy', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  { nameAr: 'جامعة غالواي', nameEn: 'University of Galway', country: 'أيرلندا', city: 'Galway', tier: 2, minGpa: 3.2, fields: ['medical', 'science', 'law', 'engineering', 'arts'], email: 'international@universityofgalway.ie', weather: 'cold', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'small', prayerRoom: 'yes' } },
  { nameAr: 'جامعة كولدج كورك', nameEn: 'University College Cork (UCC)', country: 'أيرلندا', city: 'Cork', tier: 2, minGpa: 3.1, fields: ['medical', 'science', 'business', 'law', 'arts'], email: 'international@ucc.ie', weather: 'cold', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'small', prayerRoom: 'yes' } },
  { nameAr: 'جامعة دبلن سيتي', nameEn: 'Dublin City University (DCU)', country: 'أيرلندا', city: 'Dublin', tier: 2, minGpa: 3.0, fields: ['engineering', 'cs', 'business', 'education', 'social'], email: 'international.office@dcu.ie', weather: 'cold', safety: 'very_safe', muslimFriendly: { halal: 'easy', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  { nameAr: 'جامعة مينوث', nameEn: 'Maynooth University', country: 'أيرلندا', city: 'Maynooth', tier: 2, minGpa: 3.0, fields: ['social', 'science', 'arts', 'education', 'business'], email: 'international.office@mu.ie', weather: 'cold', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'small', prayerRoom: 'yes' } },
  { nameAr: 'جامعة ليميريك', nameEn: 'University of Limerick (UL)', country: 'أيرلندا', city: 'Limerick', tier: 2, minGpa: 2.9, fields: ['engineering', 'business', 'science', 'education'], email: 'international@ul.ie', weather: 'cold', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'limited', saudiCommunity: 'small', prayerRoom: 'yes' } },
  { nameAr: 'الجامعة التكنولوجية دبلن', nameEn: 'Technological University Dublin (TU Dublin)', country: 'أيرلندا', city: 'Dublin', tier: 3, minGpa: 2.7, fields: ['engineering', 'business', 'cs', 'arts'], email: 'international@tudublin.ie', weather: 'cold', safety: 'very_safe', muslimFriendly: { halal: 'easy', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  // Malaysia
  ...
  { nameAr: 'جامعة صبانجي', nameEn: 'Sabancı University', country: 'تركيا', city: 'Istanbul', tier: 1, minGpa: 3.5, fields: ['engineering', 'cs', 'business', 'arts', 'social'], email: 'admissions@sabanciuniv.edu', weather: 'moderate', safety: 'safe', muslimFriendly: { halal: 'easy', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  ...
  { nameAr: 'جامعة بوغازيتشي', nameEn: 'Boğaziçi University', country: 'تركيا', city: 'Istanbul', tier: 1, minGpa: 3.4, fields: ['engineering', 'social', 'science', 'education'], email: 'international@bogazici.edu.tr', weather: 'moderate', safety: 'safe', muslimFriendly: { halal: 'easy', mosque: 'on_campus', saudiCommunity: 'large', prayerRoom: 'yes' } },
  { nameAr: 'جامعة الشرق الأوسط التقنية', nameEn: 'Middle East Technical University (METU)', country: 'تركيا', city: 'Ankara', tier: 1, minGpa: 3.4, fields: ['engineering', 'cs', 'science', 'business', 'arts'], email: 'intl-admissions@metu.edu.tr', weather: 'cold', safety: 'safe', muslimFriendly: { halal: 'easy', mosque: 'on_campus', saudiCommunity: 'large', prayerRoom: 'yes' } },
  { nameAr: 'جامعة إسطنبول التقنية', nameEn: 'Istanbul Technical University', country: 'تركيا', city: 'Istanbul', tier: 2, minGpa: 3.2, fields: ['engineering', 'cs', 'science', 'arts'], email: 'international@itu.edu.tr', weather: 'moderate', safety: 'safe', muslimFriendly: { halal: 'easy', mosque: 'on_campus', saudiCommunity: 'large', prayerRoom: 'yes' } },
  { nameAr: 'جامعة أنقرة', nameEn: 'Ankara University', country: 'تركيا', city: 'Ankara', tier: 2, minGpa: 3.0, fields: ['medical', 'law', 'science', 'social', 'education'], email: 'international@ankara.edu.tr', weather: 'cold', safety: 'safe', muslimFriendly: { halal: 'easy', mosque: 'on_campus', saudiCommunity: 'large', prayerRoom: 'yes' } },
  { nameAr: 'جامعة حاجة تبه', nameEn: 'Hacettepe University', country: 'تركيا', city: 'Ankara', tier: 2, minGpa: 3.1, fields: ['medical', 'engineering', 'science', 'education', 'social'], email: 'international@hacettepe.edu.tr', weather: 'cold', safety: 'safe', muslimFriendly: { halal: 'easy', mosque: 'on_campus', saudiCommunity: 'large', prayerRoom: 'yes' } },
  // Netherlands
  { nameAr: 'جامعة دلفت التقنية', nameEn: 'Delft University of Technology (TU Delft)', country: 'هولندا', city: 'Delft', tier: 1, minGpa: 3.5, fields: ['engineering', 'cs', 'science', 'arts'], email: 'international-office@tudelft.nl', weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'easy', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  { nameAr: 'جامعة أمستردام', nameEn: 'University of Amsterdam (UvA)', country: 'هولندا', city: 'Amsterdam', tier: 1, minGpa: 3.4, fields: ['business', 'law', 'social', 'science', 'arts'], email: 'international-office@uva.nl', weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'easy', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  { nameAr: 'جامعة ليدن', nameEn: 'Leiden University', country: 'هولندا', city: 'Leiden', tier: 1, minGpa: 3.4, fields: ['law', 'social', 'science', 'medical', 'arts'], email: 'studeenadviseur@leidenuniv.nl', englishGradOnly: true, weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'easy', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  ...
  { nameAr: 'جامعة آيندهوفن التقنية', nameEn: 'Eindhoven University of Technology (TU/e)', country: 'هولندا', city: 'Eindhoven', tier: 2, minGpa: 3.3, fields: ['engineering', 'cs', 'science', 'business'], email: 'international@tue.nl', weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'small', prayerRoom: 'yes' } },
  { nameAr: 'جامعة غرونينغن', nameEn: 'University of Groningen (RUG)', country: 'هولندا', city: 'Groningen', tier: 2, minGpa: 3.2, fields: ['science', 'business', 'medical', 'law', 'social'], email: 'international@rug.nl', weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'small', prayerRoom: 'yes' } },
  { nameAr: 'جامعة واخينينغن', nameEn: 'Wageningen University & Research (WUR)', country: 'هولندا', city: 'Wageningen', tier: 2, minGpa: 3.2, fields: ['science', 'engineering', 'social'], email: 'international.students@wur.nl', weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'limited', saudiCommunity: 'small', prayerRoom: 'yes' } },
  { nameAr: 'جامعة إيراسموس روتردام', nameEn: 'Erasmus University Rotterdam (EUR)', country: 'هولندا', city: 'Rotterdam', tier: 2, minGpa: 3.2, fields: ['business', 'law', 'medical', 'social'], email: 'international@eur.nl', weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'easy', mosque: 'nearby', saudiCommunity: 'medium', prayerRoom: 'yes' } },
  // France
  ...
  { nameAr: 'المدرسة العليا ليون', nameEn: 'ENS de Lyon', country: 'فرنسا', city: 'Lyon', tier: 1, minGpa: 3.6, fields: ['science', 'social', 'arts', 'education'], email: 'relations-internationales@ens-lyon.fr', englishGradOnly: true, weather: 'moderate', safety: 'very_safe', muslimFriendly: { halal: 'easy', mosque: 'nearby', saudiCommunity: 'small', prayerRoom: 'yes' } },
  ...
  { nameAr: 'جامعة ستراسبورغ', nameEn: 'University of Strasbourg', country: 'فرنسا', city: 'Strasbourg', tier: 2, minGpa: 3.1, fields: ['science', 'law', 'medical', 'social', 'arts'], email: 'international@unistra.fr', englishGradOnly: true, weather: 'mixed', safety: 'very_safe', muslimFriendly: { halal: 'moderate', mosque: 'nearby', saudiCommunity: 'small', prayerRoom: 'yes' } }
];
